...
const PostCard2 = ({ post }) => {
  return (
    <div className="w-full flex flex-col items-center space-y-5 md:w-[30%] h-96 md:h-[500px]  mb-24 p-5 pt-20 cursor-pointer group border-4 border-transparent duration-50  hover:border-sky-700 hover:bg-transparent ">
