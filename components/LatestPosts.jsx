...
const LatestPosts = ({ posts }) => {
  ...
  return (
    <div className="container mx-auto mt-32 px-5 lg:px-20">
      <h2 className="text-6xl  md:text-7xl xl:text-8xl font-semibold text-right  dark:text-white  ">
        recent<br></br> posts
      </h2>
      {/* fix */}
      <div className="border-b-4 border-sky-600 dark:border-sky-200 my-5 md:my-16 "></div>
